    ...
    return (
        ...
        >
          ...
          <div className="flex items-center gap-4 mt-auto border-t border-gray-800 pt-4">
            ...
            <a href={`https://testnet.seistream.app/tokens/0x043fdf7f85030b6cf49124675987a8526d495fd8/${result.id}?standart=erc721`} target="_blank" rel="noopener noreferrer" className="text-sm text-cyan-400 hover:text-cyan-300 transition-colors">View on Explorer</a>
          </div>
        </motion.div>
    );
};
